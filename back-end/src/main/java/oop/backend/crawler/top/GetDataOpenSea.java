...
import oop.backend.utils.sort.top.OpenSeaTopUtil;
...
public class GetDataOpenSea extends GetOpenSea {
    private final String PATH_OPEN_SEA = PathFixUtil.fix(App.class.getResource("/json/top/open_sea_data.json").getPath());
    private final AttrGetter<OpenSeaDTO> openSeaAttr = new GetAttrOpenSea();

    public GetDataOpenSea() {
