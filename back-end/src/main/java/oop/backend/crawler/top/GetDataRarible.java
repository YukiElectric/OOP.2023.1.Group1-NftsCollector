...
import oop.backend.utils.sort.top.RaribleTopUtil;
...
public class GetDataRarible extends GetRarible {
    private String PATH_RARIBLE = PathFixUtil.fix(App.class.getResource("/json/top/rarible_data.json").getPath());

    private final AttrGetter<RaribleDTO> raribleAttr = new GetAttrRarible();

    public GetDataRarible(){
